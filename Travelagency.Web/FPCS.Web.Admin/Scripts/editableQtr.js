(function ($) {
    ...
    var QtrEditable = function (options) {
        this.init('qtr_editable', options, QtrEditable.defaults);
    };

    //inherit from Abstract input
    $.fn.editableutils.inherit(QtrEditable, $.fn.editabletypes.abstractinput);

    $.extend(QtrEditable.prototype, {
        /**
    ...
    QtrEditable.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div>'+
    ...
    $.fn.editabletypes.qtr_editable = QtrEditable;
